          ...
          <tbody>
            ...
            <tr align="center">
              ...
              <td>
                ...
                <a href="action.php?id=<?php $row['ma_thu_cung']; ?>" class="badge badge-danger p-2" onclick="return confirm('Bạn chắc chắn muốn xóa dữ liệu này?');">Xóa</a> |
                <a href="index.php?id=<?php $row['ma_thu_cung']; ?>" class="badge badge-success p-2">Chỉnh sửa</a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
